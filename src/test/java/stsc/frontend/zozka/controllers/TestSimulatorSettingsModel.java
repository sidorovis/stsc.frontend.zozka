...
public class TestSimulatorSettingsModel {
	...
	public void testSaveLoad() throws FileNotFoundException, IOException, ClassNotFoundException {
		final File f = new File("./test/file_name");
		{
			...
			ed1.addTextAlgorithm(new TextAlgorithmParameter("thirdPN", ParameterType.SUB_EXECUTION, TextAlgorithmParameter
			...
			ed2.addTextAlgorithm(new TextAlgorithmParameter("TheFourthPN", ParameterType.STRING, TextAlgorithmParameter
					.createDomenRepresentation("'I','hate','stupid','people','who','are_not_writing_tests'")));
			ed2.addTextAlgorithm(new TextAlgorithmParameter("TheThirdPN", ParameterType.SUB_EXECUTION, TextAlgorithmParameter
